...
\lstinputlisting[language=C, caption = Un programma in C che calcola il prezzo di un prodotto. Esempio proveniente da \cite{DDG}, firstline = 2]{../code_examples/example2.c}
\begin{figure}[H]
    \centering
...
\lstinputlisting[language=C, caption = Un programma in C che calcola il fattoriale di un numero $n$ e la somma da $1$ a $n$. Esempio proveniente da \cite{Sclicing}, firstline = 2]{../code_examples/example3.c}
\lstinputlisting[
  language=C,
