...
Ill risultato ottenuto dell'analisi del programma con \textit{VulnDetect} è anche in questo caso quello atteso: il programma non risulta vulnerabile
...
\lstinputlisting[language = C, caption = Un programma in \textit{C} vulnearbile a CWE-131]{../tests/Arbiter/CWE-131-bad.c}
...
\lstinputlisting[language = C, caption = Un programma in \textit{C} vulnearbile a CWE-134]{../tests/Arbiter/CWE-134-bad.c}
...
\lstinputlisting[language = C, caption = Un programma in \textit{C} vulnearbile a CWE-252]{../tests/Arbiter/CWE-252-bad.c}
...
\lstinputlisting[language = C, caption = Un programma in \textit{C} vulnearbile a CWE-337]{../tests/Arbiter/CWE-337-bad.c}
